...
start(_StartType, _StartArgs) ->
	Dispatch = cowboy_router:compile([
		{'_',[
				{"/", home_page_handler, []},
                {"/api/news/homevideo", home_video_handler, []},
				...
				{"/css/[...]", cowboy_static, 
					[
                		{directory, {priv_dir, atamey, ["public/css"]}},
                ...
                {"/images/[...]", cowboy_static, 
                    [
                        {directory, {priv_dir, atamey, ["public/images"]}},
                        {mimetypes, {fun mimetypes:path_to_mimes/2, default}}
                    ]
                },
                {"/js/[...]", cowboy_static, 
                    [
                        {directory, {priv_dir, atamey, ["public/js"]}},
                        {mimetypes, {fun mimetypes:path_to_mimes/2, default}}
                    ]
                },
                {"/players/[...]", cowboy_static, 
                    [
                        {directory, {priv_dir, atamey, ["public/players"]}},
                        {mimetypes, {fun mimetypes:path_to_mimes/2, default}}
                    ]
                },
            	% {"/", cowboy_static, 
            	% 	[
             %    		{directory, {priv_dir, atamey, ["public"]}},
             %    		{file, "index.html"},
             %    		{mimetypes, {fun mimetypes:path_to_mimes/2, default}}
            	% 	]
            	% },
